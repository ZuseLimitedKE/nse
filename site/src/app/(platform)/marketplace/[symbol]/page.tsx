        ...
        <div>
          <div className="flex flex-col mb-2">
            ...
            <div className="flex items-center mt-1">
              <span className="text-2xl font-semibold mr-2">KES {stock.price.toFixed(2)}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent className="py-0">
              <div className="text-2xl font-bold">{stock.supply.toLocaleString()}</div>
          ...
          <Card>
            ...
            <CardContent className="py-0">
              <div className="text-2xl font-bold">{stock.borrow.toLocaleString()}</div>
              <div className="text-xs text-muted-foreground">{stock.exchange}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="py-0">
              <div className="text-2xl font-bold text-primary">{stock.apy}%</div>
            </CardContent>
          </Card>
            ...
            <Card className="sticky top-20">
              ...
              <CardContent>
                <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">You will {action === "buy" ? "Receive" : "Send"} ({stock.name})</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
